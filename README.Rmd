...
* The code, data, and codebook for the original Journal of Statistics Education 
(JSE) paper can be found [here](https://github.com/rudeboybert/JSE_OkCupid).
...
If you prefer having the raw and uncleaned profile data along with the complete 
essay data (as seen in the JSE paper), then you do not need this
