...
R package of OkCupid profile data from [OkCupid Profile Data for Introductory 
Statistics and Data Science 
Courses](http://www.amstat.org/publications/jse/v23n2/kim.pdf): 59,946 OkCupid
users who were living within 25 miles of San Francisco, had active profiles on
June 26, 2012, were online in the previous year, and had at least one picture in
their profile. 

Note:

* The original code, data, and codebook for the paper can be found
[here](https://github.com/rudeboybert/JSE_OkCupid).
* Due to file size restrictions, all essay responses are omitted from the
package.
...
* `profiles` consists of a cleaned-up version of the non-essay response data
more appropriate for use by novices.
* `profiles_raw` consists of the raw version of the non-essay response data 
